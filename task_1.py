...
obtained_weights, scores = big_test_ga(network_tupla, 1, "nodes", ga.fitness,
                                       ...
                                       min_mass=min_mass,
                                       max_mass=max_mass)
with open('batch/line_10_f0_ga.pkl', 'w') as f:
...
obtained_weights, scores = big_test_sa(network_tupla, 1, "nodes", sa.fitness,
                                       ...
                                       min_mass=min_mass,
                                       max_mass=max_mass)
with open('batch/line_10_f0_sa.pkl', 'w') as f:
    pickle.dump([obtained_weights, scores], f)
...
obtained_weights, scores = big_test_ga(network_tupla, 1, "nodes", ga.fitness,
                                       ...
                                       min_mass=min_mass,
                                       max_mass=max_mass)
with open('batch/line_25_f0_ga.pkl', 'w') as f:
    pickle.dump([obtained_weights, scores], f)
...
obtained_weights, scores = big_test_sa(network_tupla, 1, "nodes", sa.fitness,
                                       ...
                                       min_mass=min_mass,
                                       max_mass=max_mass)
with open('batch/line_25_f0_sa.pkl', 'w') as f:
    pickle.dump([obtained_weights, scores], f)
...
obtained_weights, scores = big_test_ga(network_tupla, 2, "nodes", ga.fitness,
                                       ...
                                       min_mass=min_mass,
                                       max_mass=max_mass)
with open('batch/lattice_5_f0_ga.pkl', 'w') as f:
    pickle.dump([obtained_weights, scores], f)
...
obtained_weights, scores = big_test_sa(network_tupla, 2, "nodes", sa.fitness,
                                       ...
                                       min_mass=min_mass,
                                       max_mass=max_mass)
with open('batch/lattice_5_f0_sa.pkl', 'w') as f:
    pickle.dump([obtained_weights, scores], f)
...
obtained_weights, scores = big_test_ga(network_tupla, 2, "nodes", ga.fitness,
                                       ...
                                       min_mass=min_mass,
                                       max_mass=max_mass)
with open('batch/lattice_10_f0_ga.pkl', 'w') as f:
    pickle.dump([obtained_weights, scores], f)
...
obtained_weights, scores = big_test_sa(network_tupla, 2, "nodes", sa.fitness,
                                       ...
                                       min_mass=min_mass,
                                       max_mass=max_mass)
with open('batch/lattice_10_f0_sa.pkl', 'w') as f:
    pickle.dump([obtained_weights, scores], f)
...
obtained_weights, scores = big_test_ga(network_tupla, 2, "nodes", ga.fitness,
                                       ...
                                       min_mass=min_mass,
                                       max_mass=max_mass)
with open('batch/lattice_20_f0_ga.pkl', 'w') as f:
    pickle.dump([obtained_weights, scores], f)
...
obtained_weights, scores = big_test_sa(network_tupla, 2, "nodes", sa.fitness,
                                       ...
                                       min_mass=min_mass,
                                       max_mass=max_mass)
with open('batch/lattice_20_f0_sa.pkl', 'w') as f:
    pickle.dump([obtained_weights, scores], f)
...
obtained_weights, scores = big_test_ga(network_tupla, 3, "nodes", ga.fitness,
                                       ...
                                       min_mass=min_mass,
                                       max_mass=max_mass)
with open('batch/cube_5_f0_ga.pkl', 'w') as f:
    pickle.dump([obtained_weights, scores], f)
...
obtained_weights, scores = big_test_sa(network_tupla, 3, "nodes", sa.fitness,
                                       ...
                                       min_mass=min_mass,
                                       max_mass=max_mass)
with open('batch/cube_5_f0_sa.pkl', 'w') as f:
    pickle.dump([obtained_weights, scores], f)
...
obtained_weights, scores = big_test_ga(network_tupla, 3, "nodes", ga.fitness,
                                       ...
                                       min_mass=min_mass,
                                       max_mass=max_mass)
with open('batch/cube_7_f0_ga.pkl', 'w') as f:
    pickle.dump([obtained_weights, scores], f)
...
obtained_weights, scores = big_test_sa(network_tupla, 3, "nodes", sa.fitness,
                                       ...
                                       min_mass=min_mass,
                                       max_mass=max_mass)
with open('batch/cube_7_f0_sa.pkl', 'w') as f:
    pickle.dump([obtained_weights, scores], f)
