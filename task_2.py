...
# Batch on v1 fitness (protecc the laplacian)
...
obtained_weights, scores = big_test_ga(network_tupla, 1, "nodes",
                                       ga.new_fitness,
                                       n_iterations,
...
obtained_weights, scores = big_test_ga(network_tupla, 2, "nodes",
                                       ga.new_fitness,
                                       n_iterations,
                                       value_resolution=value_resolution,
                                       min_mass=min_mass,
...
obtained_weights, scores = big_test_ga(network_tupla, 3, "nodes",
                                       ga.new_fitness,
                                       n_iterations,
                                       value_resolution=value_resolution,
                                       min_mass=min_mass,
